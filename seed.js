...
const users = [
    ...
    { email: 'user1@example.com', password: 'user123', role: 'user', sensorId: null },
    { email: 'user2@example.com', password: 'user123', role: 'user', sensorId: null },
];
...
const healthData = [
    { userId: '2', sensorId: 'SENSOR_002', heartRate: 72, oxygenLevel: 98, temperature: 36.6 },
    { userId: '2', sensorId: 'SENSOR_002', heartRate: 65, oxygenLevel: 97, temperature: 36.8 },
    { userId: '3', sensorId: 'SENSOR_003', heartRate: 78, oxygenLevel: 99, temperature: 36.7 },
    { userId: '3', sensorId: 'SENSOR_003', heartRate: 68, oxygenLevel: 100, temperature: 36.5 },
];
